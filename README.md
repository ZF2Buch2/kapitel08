...
Die Projektdateien für das Kapitel 08 vom Buch **Zend Framework 2 - Von den 
...
* Sie können die Projektdateien als ZIP von der Website http://www.awl.de/2994 
  unter Downloads oder von GitHub https://github.com/ZF2Buch/kapitel08 herunter
...
```
    ...
    $ git clone https://github.com/ZF2Buch/kapitel08.git
    $ cd kapitel08/
```
